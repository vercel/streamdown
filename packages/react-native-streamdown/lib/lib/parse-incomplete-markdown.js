...
exports.parseIncompleteMarkdown = void 0;
...
const handleIncompleteSingleUnderscoreItalic = (text) => {
    ...
    if (singleUnderscoreMatch) {
        ...
        // Don't close if content is only whitespace or emphasis markers
        if (!contentAfterFirstUnderscore ||
...
exports.parseIncompleteMarkdown = parseIncompleteMarkdown;
