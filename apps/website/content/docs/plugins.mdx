...
Rendering plugins provide advanced features for code blocks, diagrams, math, and CJK text. Each plugin requires installing its peer dependency. Install only what you need:
