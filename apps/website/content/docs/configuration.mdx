...
<TypeTable
  type={{
    cdnUrl: {
      description: 'Base URL for loading Shiki languages and themes. Set to null to disable CDN loading (only bundled languages/themes will work). See Offline Mode for self-hosting.',
      type: 'string | null',
      default: "'/cdn/shiki/{version}'",
    },
  }}
/>
