...
Mermaid is loaded on-demand from a CDN only when a diagram is rendered, keeping your initial bundle size small. See [Offline Mode](/docs/offline-mode) for self-hosting options.
